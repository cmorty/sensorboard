...
uint8_t usiTwiRxBuf[TWI_RX_BUFFER_SIZE];
static uint8_t usiTwiRxPos;

uint8_t usiTwiTxBuf[TWI_TX_BUFFER_SIZE];
static uint8_t usiTwiTxPos;
static uint8_t usiTwiTxSize;

static uint8_t (*cbTx)(void) = 0;
static uint8_t (*cbRx)(uint8_t len) = 0;
